...
import { setPaletteOpen } from "@/redux/reducers/ConfigReducer";
...
export default function CommandPalette() {
  ...
  return (
    <div className={styles.overlay} role="dialog" aria-modal="true" aria-label="Search">
      <div className={styles.palette} ref={ref} onKeyDown={onKeyDown}>
          ...
          {results.map((item, index) => {
            ...
            return (
              <div key={`${item.group}-${item.href}-${item.label}`}>
                ...
                <button
                  type="button"
                  className={cx(styles.item, index === cursor && styles.itemActive)}
